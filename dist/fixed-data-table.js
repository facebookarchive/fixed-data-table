...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FixedDataTable = createReactClass({
	  ...
	  _calculateState: function _calculateState( /*object*/props, /*?object*/oldState) /*object*/{
	    ...
	    if (oldState && (props.width !== undefined && props.width !== oldState.width || props.height !== undefined && props.height !== oldState.height || props.maxWidth !== undefined && props.maxWidth !== oldState.maxWidth || props.maxHeight !== undefined && props.maxHeight !== oldState.maxHeight)) {
	      oldState = null;
	    }
