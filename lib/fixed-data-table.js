...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTable = React.createClass({displayName: "FixedDataTable",
      ...
      if (columnResizingData) {
        newState.columnResizingData = columnResizingData;
      }

      newState.columnResizingData.firstRowIndex = firstRowIndex;
      newState.columnResizingData.firstRowOffset =firstRowOffset;
      newState.columnResizingData.horizontalScrollbarVisible = horizontalScrollbarVisible;
      newState.columnResizingData.maxScrollX = maxScrollX;
      newState.columnResizingData.reservedHeight = totalHeightReserved;
      newState.columnResizingData.scrollContentHeight = scrollContentHeight;
      newState.columnResizingData.scrollX = scrollX;
      newState.columnResizingData.scrollY = scrollY;
