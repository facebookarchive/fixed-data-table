(function (root, factory) {
      ...
      var FixedDataTable = React.createClass({displayName: "FixedDataTable",
        ...
        _calculateState:function(/*object*/ props, /*?object*/ oldState) /*object*/ {
          ...
          /*var newState = {};
           ...
           if (oldState) {
           newState.isColumnResizing = oldState.isColumnResizing;
           } else {
           newState.isColumnResizing = {};
           }

           newState.columnResizingData = {};

           if (columnResizingData) {
           for (var attr in columnResizingData) {
           newState.columnResizingData[attr] = columnResizingData[attr];
           }
           }

           newState.firstRowIndex = firstRowIndex;
           newState.firstRowOffset =firstRowOffset;
           newState.horizontalScrollbarVisible = horizontalScrollbarVisible;
           newState.maxScrollX = maxScrollX;
           newState.reservedHeight = totalHeightReserved;
           newState.scrollContentHeight = scrollContentHeight;
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      ImmutableValue.mergeAllPropertiesInto=function(destination, propertyObjects) {
        ...
        for (var i = 0; i < argLength; i++) {
          /*if (destination && propertyObjects[i]) {
           for (var attr in propertyObjects[i]) {
           destination[attr] = propertyObjects[i][attr];
           }
           }*/
  ...
  /* end of fixed-data-table.js */

  /*global define */

  define('FixedDataTable',[
    'require',
    './FixedDataTable',
    './FixedDataTableRoot',
    './FixedDataTableColumn',
    './FixedDataTableColumnGroup',
    './FixedDataTableHelper',
    './Locale',
    './Scrollbar',
    './FixedDataTableBufferedRows',
    './FixedDataTableColumnResizeHandle',
    './FixedDataTableRow',
    './FixedDataTableScrollHelper',
    ...
    return {
      FixedDataTable: require('./FixedDataTable'),
      FixedDataTableRoot: require('./FixedDataTableRoot'),
      FixedDataTableColumn:require('./FixedDataTableColumn'),
      FixedDataTableColumnGroup: require('./FixedDataTableColumnGroup'),
      FixedDataTableHelper: require('./FixedDataTableHelper'),
      Locale: require('./Locale'),
      Scrollbar: require('./Scrollbar'),
      FixedDataTableBufferedRows: require('./FixedDataTableBufferedRows'),
      FixedDataTableColumnResizeHandle: require('./FixedDataTableColumnResizeHandle'),
      FixedDataTableRow: require('./FixedDataTableRow'),
      FixedDataTableScrollHelper: require('./FixedDataTableScrollHelper'),
      FixedDataTableWidthHelper: require('./FixedDataTableWidthHelper'),
      cx: require('./cx'),
      debounce: require('./debounce'),
      emptyFunction: require('./emptyFunction'),
      invariant: require('./invariant'),
      shallowEqual: require('./shallowEqual'),
      translateDOMPositionXY: require('./translateDOMPositionXY'),
      React: require('./React'),
      DOMMouseMoveTracker: DOMMouseMoveTracker('./DOMMouseMoveTracker'),
      cssVar: require('./cssVar'),
      FixedDataTableRowBuffer: require('./FixedDataTableRowBuffer'),
      joinClasses: require('./joinClasses'),
      clamp: require('./clamp'),
      FixedDataTableCellGroup: require('./FixedDataTableCellGroup'),
      PrefixIntervalTree: require('./PrefixIntervalTree'),
      normalizeWheel: require('./normalizeWheel'),
      requestAnimationFrame: require('./requestAnimationFrame'),
      BrowserSupportCore: require('./BrowserSupportCore'),
      getVendorPrefixedName: require('./getVendorPrefixedName'),
      EventListener: require('./EventListener'),
      cancelAnimationFrame: require('./cancelAnimationFrame'),
      IntegerBufferSet: require('./IntegerBufferSet'),
      ImmutableObject: require('./ImmutableObject'),
      FixedDataTableCell: require('./FixedDataTableCell'),
      UserAgent_DEPRECATED: require('./UserAgent_DEPRECATED'),
      ...
      Heap: require('./Heap'),
      ImmutableValue: require('./ImmutableValue'),
      keyOf: require('./keyOf'),
